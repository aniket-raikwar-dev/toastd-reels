...
const PlayPauseButtons = ({ togglePlayPause, isPlaying, reel }) => {
  return (
    <div
      onClick={togglePlayPause}
      className="absolute left-6 lg:bottom-14 bottom-8 flex flex-col gap-6"
    >
      <button className="flex items-center">
        ...
        <span className="py-0.5 px-4 border rounded-full ml-2 text-sm video-title">
          {reel.title}
        </span>
      </button>
    </div>
